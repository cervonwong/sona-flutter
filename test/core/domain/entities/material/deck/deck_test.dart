...
void main() {
  ...
  test(
    'Deck when constructed with null for non-nullable parameters, '
    'should fail asserts',
    () {
      final id = 3;
  ...
  test(
    'Deck when constructed with entries containing null, '
    'should fail asserts',
    () {
      expect(
        () => Deck(
  ...
  test(
    'Deck when constructed with createdDateTime after lastEditedDateTime, '
    'should fail asserts',
    () {
      expect(
        () => Deck(
  ...
  test(
    'Deck when equating logically equal Decks, '
    'should return true',
    () {
      final deck1 = Deck(
        id: 9,
  ...
  test(
    'Deck when equating logically unequal Decks, '
    'should return false',
    () {
