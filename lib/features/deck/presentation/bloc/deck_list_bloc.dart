...
import 'to_deck_list_view_model_mapper.dart';
...
class DeckListBloc extends Bloc<DeckListEvent, DeckListState> {
  ...
  final ToDeckListViewModelMapper _toDeckListViewModel;
